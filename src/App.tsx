...
function App() {
    return (
        <Layout>
            <Box display={{base: 'block', md: 'flex'}} gap="4">
                <Card size="md" mt="4" width={{base: 'block', md: "50%"}}>
                    <CardBody>
                        ...
                        <Box display={{base: 'block', md: 'flex'}} justifyContent="space-between" gap="4" my="4">
                ...
                <Card size="md" mt="4" width={{base: 'full', md: '50%'}}>
                    <CardBody>
                        ...
                        >
                            ...
                            <Image 
                                src='/assets/regular-attendees-banner.jpg' 
                                alt="Regulare Attendees Banner" 
                                width={{base: "full", md: "250px"}}
                                aspectRatio="16/9"
                            />
                        </Box>
            ...
            <Box display={{base: 'block', md: 'flex'}} gap="4" mt="8">
                <Box textAlign="center" width={{base: 'full', md: '50%'}}>
